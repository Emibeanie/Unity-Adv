...
public class Unit : MonoBehaviour
{
   ...
   [SerializeField] private float moveDetect;
   [SerializeField] private float speedAnimMin;
   

   private bool _isMoving;
   private bool _isNavMeshMoving => navMeshAgent.velocity.magnitude > moveDetect;
